...
def get_subjects_by_class(class_num, student):
    ...
    class_subjects = {
        6: ["English", "Urdu", "Mathematics", "Science", "His. Geo", "Islamiat", "Tarjama Tul Quran", "Computer",
            "Ethics"],
        7: ["English", "Urdu", "Mathematics", "Science", "His. Geo", "Islamiat", "Tarjama Tul Quran", "Computer",
            "Ethics"],
        8: ["English", "Urdu", "Mathematics", "Science", "His. Geo", "Islamiat", "Tarjama Tul Quran", "Computer",
            "Ethics"],
...
for index, student in df.iterrows():
    ...
    html_template += f"""
        ...
        <div class="quote">Children are the nation's valuable asset; educate them for a brighter future.</div>
    </div>
    """
